...
<center>
![](images/thelionthewitchandthewardrobe.jpg){width=18%} 
![](images/thepoisonwoodbible.jpg){width=18%}
![](images/thecroniclesofnarnia.jpg){width=18%}
![](images/thefivepeopleyoumeetinheaven.jpg){width=18%}
![](images/unbroken.jpg){width=18%}
...
```{r, eval=FALSE, echo=FALSE,out.width="11%",fig.cap="Books that we liked",fig.show='hold',fig.align='center'}
...
```{r, eval=FALSE, echo=FALSE,out.width="11%",fig.cap="Books that we did not like",fig.show='hold',fig.align='center'}
