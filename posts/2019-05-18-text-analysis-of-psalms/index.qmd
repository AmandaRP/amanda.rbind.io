...
categories: 
  ...
  - sentiment
  - bible
description: "Sentiment analysis of Psalms using the `tidytext` and `sentimentr` packages"
code-copy: true
draft: false
---
...
We see here that [Chapter 150](https://www.biblegateway.com/passage/?search=Psalms+150&version=GNT) is the most positive and [Chapter 10](https://www.biblegateway.com/passage/?search=Psalms+10&version=GNT) is the most negative. In Chapter 10, the psalmist laments about the wicked and asks God to "hear the desire of the afflicted." Here is a sample:
...
Now, after taking valence shifters into account, [Chapter 67](https://www.biblegateway.com/passage/?search=Psalms+67&version=GNT) is the most positive while [Chapter 10](https://www.biblegateway.com/passage/?search=Psalms+10&version=GNT) is still the most negative. Chapter 67 is a short chapter (only 7 verses), a song written for the director of music. Here is a sample of verses 3 and 4:
...
Additionally, between the two analyses, [Chapter 13](https://www.biblegateway.com/passage/?search=Psalms+13&version=GNT) switched from a very slight negative sentiment (-0.0038) to a somewhat positive sentiment (0.1513). This chapter had the largest score change between the two analyses.
